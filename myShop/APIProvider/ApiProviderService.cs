...
namespace myShop
{
    public class ApiProviderService : IApiProviderService
    {
        ...
        private async Task<T> PostAsync<T, U>(U vehicleModel, string pathUrl)
        {
            string serializedResponse = null;
            string Content = JsonConvert.SerializeObject(vehicleModel);
        ...
        // public async Task<IEnumerable<SearchCars>> SearchCarAsync(CarModel cars)
        // {
        //     return await SearchAsync<IEnumerable<SearchCars>, CarModel>(cars, "/api/vehicleSearch/search");
        // }
